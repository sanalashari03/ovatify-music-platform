...
@php
    $steps = [
        ['number' => 1, 'label' => 'Draft', 'icon' => 'fas fa-file-alt'],
        ['number' => 2, 'label' => 'Creation', 'icon' => 'fas fa-magic'],
        ['number' => 3, 'label' => 'Refine', 'icon' => 'fas fa-sliders-h'],
        ['number' => 4, 'label' => 'Mixing', 'icon' => 'fas fa-wave-square'],
        ['number' => 5, 'label' => 'Finish', 'icon' => 'fas fa-check-circle'],
    ];
...
<div class="w-full mb-12">
    <div class="relative flex justify-between items-center max-w-[900px] mx-auto">
        {{-- Progress Line Background --}}
        <div class="absolute top-[28px] left-[5%] right-[5%] h-[2px] bg-white/5 -z-10"></div>

        {{-- Active Progress Line --}}
        <div class="absolute top-[28px] left-[5%] h-[2px] bg-gradient-to-r from-[#4D61FF] to-[#FF00FF] transition-all duration-700 ease-in-out -z-10"
            style="width: calc({{ $progressPercentage }}% - ({{ $progressPercentage / 10 }}%))">
        </div>
        ...
        @foreach($steps as $step)
            ...
            <div class="flex flex-col items-center gap-4 group">
                ...
                <div @class([
                    ...
                    'bg-[#4D61FF] border-[#4D61FF] shadow-[0_0_20px_rgba(77,97,255,0.4)] scale-110' => $isActive,
