...
<body class="min-h-screen flex items-center justify-center p-6 bg-[#0D0D0D]">
    ...
    <div class="w-full max-w-[420px] text-center">
        ...
        <div class="mb-12">
            ...
            <p class="text-[14px] font-medium text-white/40">Code has been sent to {{ $contact }}</p>
        </div>
        ...
        <form action="{{ route('forgot.verification.post') }}" method="POST" id="verification-form">
            @csrf
