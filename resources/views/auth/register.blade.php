    ...
    <div class="w-full max-w-[1200px] grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <div class="max-w-[420px] w-full mx-auto lg:ml-0">
            <div class="mb-10 text-left">
                ...
                <h2 class="text-[32px] font-bold text-magenta leading-tight tracking-tight">Sign up to get started</h2>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <input type="hidden" name="username" value="user_{{ time() }}">

                <div class="space-y-2">
                    <label class="text-[13px] font-semibold text-white/90">Phone No</label>
                    <input type="text" name="phone" value="{{ old('phone') }}" placeholder="Enter your phone number"
                        class="w-full input-dark rounded-xl px-5 py-3.5 text-[13px] font-medium" required />
                </div>
                ...
                <p class="text-center text-[12px] font-medium text-white/50 pt-10">
                    ...
                    <a href="{{ route('login') }}"
                        class="text-[#4D61FF] font-extrabold hover:text-white transition-colors ml-1">Login</a>
                </p>
            </form>
        </div>
