...
@section('content')
    <div class="max-w-[1000px] mx-auto pb-20 relative" x-data="{ selected: 'investment' }">
        ...
        <div class="flex items-center gap-4 pt-4 mb-10">
            ...
            <h1 class="text-[#4D61FF] text-3xl font-bold">Congratulations, Your track is for sale!</h1>
        </div>
        ...
        <div class="pt-20 space-y-4">
            <button
                @click="if(selected === 'investment') window.location.href='{{ route('consumer.forms.investment-settings') }}';
